...
<body>
  ...
  <div class="container flex-grow-1 container-p-y">
   ...
   <!-- Expense Overview -->
   <div class="col-md-5 order-1 mb-4">
                  <div class="card h-100">
                    <div class="card-header">
                    ...
                    <div class="card-body px-0">
                      <div class="tab-content p-0">
                        <div class="tab-pane fade show active" id="navs-tabs-line-card-income" role="tabpanel">
                          ...
                          <div id="totalCollectionChart"></div>
                ...
                <!--/ Expense Overview -->
      <div class="col-md-3 col-lg-4 order-1 mb-4">
        <div class="card h-100">
          <div class="card-header">
    ...
    <div class="row">
      <div class="col-md-4 order-1 mb-4">
          <div class="card h-100">
            ...
            <div class="card-body px-0">
              <div id="SummaryCollection" style="text-align: -webkit-center;"></div>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 order-1 mb-4">
          <div class="card h-100">
            <div class="card-header">
              <h5>Penalty Collection</h5>
            </div>
            <div class="card-body px-0">
              <div id="PenaltyCollection" style="text-align: -webkit-center;"></div>
            </div>
          </div>
        </div>
    </div>
...
<script>
    $(document).ready(function(){
      ...
      $('#dashBoardMenuLink').attr({'href':'javascript:void(0);'});
      ...
      success: function(response) {
        ...
        $('#collectedToday').html('₱' + parseFloat(data.TodayCollection).toLocaleString());
        ...
        var options = {
          ...
          plotOptions: {
            radialBar: {
              hollow: {
                size: '70%',
                image: '../assets/img/landing/totalloans.svg',
                imageWidth: 52,
                imageHeight: 52,
                imageClipped: false,
                imageOffsetY: -20
        ...
        var chart = new ApexCharts(document.querySelector("#SummaryCollection"), options);
        chart.render();
        ...
        var options2 = {
          ...
          plotOptions: {
            radialBar: {
              hollow: {
                size: '70%',
                image: '../assets/img/landing/activeloan.svg',
                imageWidth: 52,
                imageHeight: 52,
                imageClipped: false,
                imageOffsetY: -20
        ...
        var options3 = {
          ...
          plotOptions: {
            radialBar: {
              hollow: {
                size: '70%',
                image: '../assets/img/landing/overdue.svg',
                imageWidth: 52,
                imageHeight: 52,
                imageClipped: false,
                imageOffsetY: -20
        ...
        var options4 = {
          ...
          plotOptions: {
            radialBar: {
              hollow: {
                size: '70%',
                image: '../assets/img/landing/penalty.svg',
                imageWidth: 52,
                imageHeight: 52,
                imageClipped: false,
                imageOffsetY: -20
              ...
              dataLabels: {
                ...
                total: {
                  show: true,
                  label: '₱ ' + parseFloat(data.PenaltyCollection).toLocaleString(),
        ...
        var overDueChart = new ApexCharts(document.querySelector("#PenaltyCollection"), options4);
        overDueChart.render();
    ...
    $.ajax({
      ...
      success: function(response) {
        ...
        const tcChartEl = document.querySelector('#totalCollectionChart'),
        tcChartConfig = {
          series: [
            {
              data: [dataMonthly[0], dataMonthly[1], dataMonthly[2], dataMonthly[3], dataMonthly[4], dataMonthly[5], dataMonthly[6], dataMonthly[7], dataMonthly[8], dataMonthly[9], dataMonthly[10], dataMonthly[11]]
      ...
      if (typeof tcChartEl !== undefined && tcChartEl !== null) {
        const tc = new ApexCharts(tcChartEl, tcChartConfig);
        tc.render();
      }
      }
    });
