<!-- <div class="sidebar-header">
    <img src="/ems/assets/img/logo_t.png" alt="icon">
    <hr>
</div>
<ul class="list-unstyled components">
    <p>MENUS</p>
    <li> <a href="/ems/admin"><i class='fa fa-home'></i> HOME</a> </li>
    <li> <a href="#homeSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class='fa fa-folder'></i> MANAGE RECORDS</a>
        <ul class="collapse list-unstyled" id="homeSubmenu">
            <li> <a href="/ems/admin/users.php"><i class='fa fa-users'></i> USERS</a> </li>
            <li> <a href="/ems/admin/events.php"><i class='fa fa-calendar'></i> EVENTS</a> </li>
        </ul>
    </li>
</ul>
<p class="fixed-bottom text-center m-0">Copyright ©2023 EVENT MANAGEMENT SYSTEM USING QR CODE.</p> -->
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item" id="mu-menu">
              <a href="./users.php" class="menu-link" id="userMenuLink">
            ...
            <li class="menu-item" id="la-menu">
              <a href="./loanapplications.php" class="menu-link" id="loanAppMenuLink">
                <i class="menu-icon tf-icons bx bx-dollar-circle"></i>
                <div data-i18n="Dashboards">Loan Applications</div>
                <div class="badge bg-danger rounded-pill ms-auto"><?php echo $_SESSION['loanCount'] ?></div>
              </a>
            </li>
